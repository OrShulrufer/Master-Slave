...
def send_sqs_message(message, url):
    sqs = boto3.client('sqs', region_name="eu-central-1", aws_access_key_id='',
...
def upload_file(file_name, bucket_name, object_name=None):
    ...
    # Upload the file
    s3_client = boto3.client('s3', region_name='eu-central-1', aws_access_key_id='',
                             aws_secret_access_key='')
    try:
...
def read_image_from_s3(bucket_name, key, region_name='eu-central-1'):
    s3 = boto3.resource('s3', region_name='eu-central-1', aws_access_key_id='',
                        aws_secret_access_key='')
